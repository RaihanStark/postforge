// Repair PATH when PostForge is launched as a packaged desktop app.
//
...
// that omits things like /usr/local/bin, Homebrew, asdf, and nvm. We fix this by
// asking the user's login shell for its real PATH and adopting it, so any child
// process PostForge spawns can find the toolchain the user actually has.
// No-op on Windows, which doesn't have this login-shell-PATH problem.
import { execFileSync } from 'node:child_process'

const MARKER = '_POSTFORGE_PATH_'
